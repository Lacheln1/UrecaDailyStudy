            ...
            <div className={styles.modalContent}>
                ...
                <div className={styles.modalBody}>
                    <FilterButton
                        ...
                        onSelect={(value) =>
                            setTempFilters((prev) => ({ ...prev, network: value }))
                        }
                        label="네트워크"
                    />
                    ...
                    <FilterButton
                        ...
                        onSelect={(value) =>
                            setTempFilters((prev) => ({ ...prev, dataPrice: value }))
                        }
                        label="가격대"
                    />
                    ...
                    <FilterButton
                        ...
                        onSelect={(value) =>
                            setTempFilters((prev) => ({ ...prev, dataType: value }))
                        }
                        label="데이터 타입"
                    />

                    <AppSelector
                        selectedApps={tempFilters.selectedApps}
